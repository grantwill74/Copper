...
namespace Mono.CSharp
{
	...
	public class Evaluator {
		...
		InputKind ToplevelOrStatement (SeekableStreamReader seekable)
		{
			...
			case Token.STATIC:
			case Token.STRUCT:
            case Token.COMPONENT: //+COPPER
            case Token.PORT: //+COPPER: Ports are allowed to be TopLevels for port interfaces 
                             //         but the grammar forbids concrete ports outside a class/component.
