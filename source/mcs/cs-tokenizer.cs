...
namespace Mono.CSharp
{
	...
	public class Tokenizer : yyParser.yyInput
	{
		...
		static Tokenizer ()
		{
            ...
            //COPPER
            AddKeyword( "multiport", Token.MULTIPORT );
            AddKeyword( "port", Token.PORT );
            AddKeyword( "component", Token.COMPONENT );
            AddKeyword( "connect", Token.CONNECT );
            AddKeyword( "disconnect", Token.DISCONNECT );
            AddKeyword( "with", Token.WITH );
            AddKeyword( "attach", Token.ATTACH );
            AddKeyword( "detach", Token.DETACH );
            AddKeyword( "embed", Token.EMBED );
		...
		int GetKeyword (char[] id, int id_len)
		{
			...
			case Token.PARTIAL:
				...
				bool ok = (next_token == Token.CLASS) ||
                    ...
                    (next_token == Token.COMPONENT) || //COPPER
